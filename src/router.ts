...
class Router {
    ...
    constructor(server: express.Express) {
        ...
        cats[uuid()] = { id: 1, genus: "feline", name: "Cosmo", isHungry: true, lastFedDate: new Date() }
        cats[uuid()] = { id: 2, genus: "feline", name: "Emmy", isHungry: true, lastFedDate: new Date() }
        cats[uuid()] = { id: 3, genus: "male", name: "energetic", isHungry: false, lastFedDate: new Date() }
